...
A constant finalization reward can fail to incentivize finalization when network fees exceed the fixed reward, leading to indefinite non-completion in practice.
