...
また、addrdeployer $=$ addrC とし、nonce による一意化を含めて cid を導出し、例えば
\[
	\mathrm{cid} := H(\mathrm{addrdeployer} \parallel \mathrm{nonce} \parallel \mathrm{tindex} \parallel \mathrm{init\_params\_bytes})
\]
