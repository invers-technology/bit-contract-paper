...
\begin{itemize}
	...
	\item \texttt{0x0005}：\texttt{payload\_bytes}（TLV bytes）
\end{itemize}
InitParams の最小例では、\texttt{0x0101}=m(u16), \texttt{0x0102}=d(u64),
\texttt{0x0103}=t(u64), \texttt{0x0104}=b(u16) を用いる。

\begin{verbatim}
Canonical example
init_params_bytes (hex):
0101020001 010208000000000000000a 0103080000000000000014 0104020001

aux (hex):
0001020001 00020101 000320aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
00040400000001 0005200101020001010208000000000000000a01030800000000000000140104020001
